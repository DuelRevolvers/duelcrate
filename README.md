...
- **Five game styles** — build and run your own custom games:
  ...
  - **Prompt Battle** — everyone writes a response to a prompt, then votes for the best; top three vote-getters score
...
- **Voting rounds** — Prompt Battle responses are shuffled and anonymous until the votes are in, self-votes are blocked, and the host can reveal responses one at a time or all at once
