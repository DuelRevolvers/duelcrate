...
- 🛠️ **Full game editor** — create, edit, duplicate, and delete your own games, with autosave as you type
...
- 🗳️ **Voting rounds** — Punchline Showdown responses are shuffled and anonymous until the votes are in, self-votes are blocked, and the host can reveal responses one at a time or all at once
...
- ⏱️ **Host controls** — configurable answer, buzz-in, and writing timers, live score tracking, and full judge control over every round
